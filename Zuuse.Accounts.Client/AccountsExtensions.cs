...
namespace Zuuse.Accounts.Client
{
    ...
    public static partial class AccountsExtensions
    {
            ...
            /// </param>
            public static void GetListClients(this IAccounts operations)
            {
                operations.GetListClientsAsync().GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task GetListClientsAsync(this IAccounts operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.GetListClientsWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// </param>
            public static string PostCreateClient(this IAccounts operations, ClientModel request)
            {
                return operations.PostCreateClientAsync(request).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<string> PostCreateClientAsync(this IAccounts operations, ClientModel request, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.PostCreateClientWithHttpMessagesAsync(request, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static void GetRetrieveClient(this IAccounts operations, string client)
            {
                operations.GetRetrieveClientAsync(client).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task GetRetrieveClientAsync(this IAccounts operations, string client, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.GetRetrieveClientWithHttpMessagesAsync(client, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// Complete details of the client
            /// </param>
            public static void PutUpdateClient(this IAccounts operations, string client, ClientModel request)
            {
                operations.PutUpdateClientAsync(client, request).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PutUpdateClientAsync(this IAccounts operations, string client, ClientModel request, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.PutUpdateClientWithHttpMessagesAsync(client, request, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// </param>
            public static void DeleteClient(this IAccounts operations, string client)
            {
                operations.DeleteClientAsync(client).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteClientAsync(this IAccounts operations, string client, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteClientWithHttpMessagesAsync(client, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
